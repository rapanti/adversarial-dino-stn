...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='vit_small', type=str,
                        choices=['vit_pico', 'vit_micro', 'vit_nano', 'vit_tiny', 'vit_small', 'vit_base', 'xcit',
                                 'deit_tiny', 'deit_small'] + torchvision_archs + torch.hub.list("facebookresearch/xcit:main"),
...
def train_dino(args):
    ...
    elif not args.use_stn_optimizer:
    ...
    if utils.is_main_process():
        summary_writer = utils.SummaryWriterCustom(log_dir=Path(args.output_dir) / "summary", plot_size=args.summary_plot_size)
